...
model = load_model('D:/Wild Animal Detection Project/Code/keras_model.h5')
...
while True:
    ...
    if class_label in ['TIGER','LION','CHEETCH','HYENA','ELEPHANT','FOX','LEOPARD','RHINOCEROS','SNAKE','WOLF'] and time.time() - last_detection_time >=5 :
